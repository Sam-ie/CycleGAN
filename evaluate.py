...
parser.add_argument("--x_test_data_path", default='E:\dataset\IntelAir\seg_test\seg_test\street', help="path of x test datas.")  # x域的测试图片路径
parser.add_argument("--y_test_data_path", default='E:/dataset/water/test_samples/Inp', help="path of y test datas.")  # y域的测试图片路径
